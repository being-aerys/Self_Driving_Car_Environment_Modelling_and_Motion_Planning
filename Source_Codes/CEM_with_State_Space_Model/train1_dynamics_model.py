...
class Environment_Model_Architecture(nn.Module):
    ...
    def forward(self):
        ...
        reward_0,obs_0 = self.obseration_and_reward_decoder(self.next_state_0)
        ...
        reward_1,obs_1 = self.obseration_and_reward_decoder(self.next_state_1)
        self.next_state_2 = self.transition_module(self.next_state_1, self.one_hot_action_2)
        reward_2,obs_2 = self.obseration_and_reward_decoder(self.next_state_2)


        return reward_0, obs_0, reward_1, obs_1, reward_2, obs_2
